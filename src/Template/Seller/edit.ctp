    ...
    <div class="col-lg-6">
        <div class="row">
            <div class="col-md-12 btn-group" >
                <?=$this->Html->link(BUTTON_BACK,['action'=>'index','defaultSearch'=>(isset($defaultSearch)?$defaultSearch:'')],['escape'=>false])?>
            </div>
        </div>
        <div class="hpanel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12" style="padding-bottom: 10px;">
                        <?php if(isset($user->user_images[0]->image->name)){ ?>
                         <?= $this->Html->image('upload/'.$user->user_images[0]->image->name,['class'=>'','width'=>'250px']) ?>
                        <?php }else{?>
                        <?= $this->Html->image('blog_thumb_1.jpg',['class'=>'','width'=>'250px']) ?>
                        <?php }?>
                    </div>
                    <div class="col-xs-12">
