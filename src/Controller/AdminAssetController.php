...
class AdminAssetController extends AppController {
    ...
    public function add() {
        ...
        $googleMapBkk = ['lat' => 13.7245601, 'long' => 100.4930261];

        $this->set(compact('asset', 'assetTypes', 'users', 'zones', 'provinces', 'directions', 'facis', 'placs', 'googleMapBkk'));
    ...
    public function edit($id = null) {
        ...
        $this->set(compact('asset', 'assetTypes', 'users', 'zones', 'provinces', 'title', 'directions', 'facis', 'placs', 'googleMapBkk'));
        $this->set('_serialize', ['asset']);
